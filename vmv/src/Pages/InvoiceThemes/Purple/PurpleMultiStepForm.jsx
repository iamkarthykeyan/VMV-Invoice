...
import PurpleFormPrice from './PurpleFormPrice'
import PurplePdf from './PurplePdf'
import DownloadExcel from "../../Download/DownloadExcel";
import DownloadCsv from "../../Download/DownloadCsv";

const PurpleMultiStepForm = () => {
    ...
    const renderStepContent = () => {
        switch (step) {
            ...
            case 3:
                return (
                    <div>
                        <PurpleFormPrice rows={rows} setRows={handleUpdateRows} />
                    </div>
                );
            case 4:
                return (
            ...
            case 5:
                return (
                    <div>
                        ...
                        <PurplePdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
