                ...
                <div ref={pdfRef} className="min-h-screen bg-white flex items-center justify-center p-10">
                    <div className="bg-white rounded-lg shadow-lg max-w-3xl w-full">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-2 gap-6">
                            {/* Left Section */}
                            <div className="bg-yellow-500 text-white p-6 rounded-xl relative flex flex-col justify-between">
                                <div>
                            ...
                            {/* Right Section */}
                            <div className="border-2 border-yellow-500 p-6 rounded-xl flex flex-col justify-between">
                                <div>
                            ...
                            <div className="max-w-4xl mx-0 my-10">
                                <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="relative bg-white">
                                        <div className="bg-yellow-500 text-white py-6 px-8 rounded-t-xl">
                                            <div className="space-y-4">
                                                ...
                                                <div className="border-t-2 border-yellow-300 mt-4"></div>
