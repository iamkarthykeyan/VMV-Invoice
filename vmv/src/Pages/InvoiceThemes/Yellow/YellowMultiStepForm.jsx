...
import YellowFormPrice from './YellowFormPrice'
import YellowPdf from './YellowPdf'
import DownloadCsv from '../../Download/DownloadCsv';
import DownloadExcel from '../../Download/DownloadExcel';

function YellowMultiStepForm() {
    ...
    const renderStepContent = () => {
      switch (step) {
          ...
          case 3:
              return (
                  <div>
                      <YellowFormPrice rows={rows} setRows={handleUpdateRows} />
                  </div>
              );
          case 4:
              return (
          ...
          case 5:
              return (
                  <div>
                      ...
                      <YellowPdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
...
export default YellowMultiStepForm
