    ...
    const renderStepContent = () => {
        switch (step) {
            ...
            case 3:
                return (
                    <div>
                        <BlueFormPrice rows={rows} setRows={handleUpdateRows} />
                    </div>
                );
            case 4:
                return (
            ...
            case 5:
                return (
                    <div>
                        ...
                        <BluePdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
...
export default BlueMultiStepForm;
