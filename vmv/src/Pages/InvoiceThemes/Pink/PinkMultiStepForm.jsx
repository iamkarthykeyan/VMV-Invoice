...
import PinkFormPrice from "./PinkFormPrice";
import PinkPdf from "./PinkPdf";

const PinkMultiStepForm = () => {
    ...
    const renderStepContent = () => {
        switch (step) {
            ...
            case 3:
                return (
                    <div>
                        <PinkFormPrice rows={rows} setRows={handleUpdateRows} />
                    </div>
                );
            case 4:
                return (
            ...
            case 5:
                return (
                    <div>
                        ...
                        <PinkPdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
