...
import GreenPdf from "./GreenPdf"
import GreenFormPrice from "./GreenFormPrice";

const GreenMultiStepForm = () => {
    ...
    const renderStepContent = () => {
        switch (step) {
            ...
            case 3:
                return (
                    <div>
                        <GreenFormPrice rows={rows} setRows={handleUpdateRows} />
                    </div>
                );
            case 4:
                return (
            ...
            case 5:
                return (
                    <div>
                        ...
                        <GreenPdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
...
export default GreenMultiStepForm;
