...
import OrangePdf from "./OrangePdf";
import OrangeFormPrice from './OrangeFormPrice'

const OrangeMultiStepForm = () => {
    ...
    const renderStepContent = () => {
        switch (step) {
            ...
            case 3:
                return (
                    <div>
                        <OrangeFormPrice rows={rows} setRows={handleUpdateRows} />
                    </div>
                );
            case 4:
                return (
            ...
            case 5:
                return (
                    <div>
                        ...
                        <OrangePdf rows={rows} formData={formData} /> {/* Pass props to DownloadPdf */}
