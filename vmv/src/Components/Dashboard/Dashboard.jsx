...
import { FiHome, FiActivity, FiBarChart2, FiBox, FiUsers, FiClipboard, FiGlobe, FiDollarSign, FiSettings } from 'react-icons/fi';
      ...
      <aside className="w-64 bg-white shadow-lg p-6 flex flex-col justify-between">
        <div>
          ...
          <ul className="space-y-2">
            ...
            <MenuItem icon={FiActivity} label="Transactions" active={activeMenu === 'transactions'} onClick={() => setActiveMenu('transactions')} />
...
const Home = () => <h2 className="text-3xl font-semibold">Home</h2>;
const Transactions = () => <h2 className="text-3xl font-semibold">Transactions</h2>;
